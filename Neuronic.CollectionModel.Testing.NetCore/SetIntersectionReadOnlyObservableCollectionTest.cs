...
{
    [TestClass]
    public class SetIntersectionReadOnlyObservableCollectionTest
    {
        [TestMethod]
        public void TestCreation()
        {
            ...
            var inter = new SetIntersectionReadOnlyObservableCollection<int>(items, sItems);

            var set = new HashSet<int>(items);
            set.IntersectWith(sItems);
            Assert.IsTrue(set.SetEquals(inter));
        }
        ...
        public void TestCreationWithCustomComparer()
        {
            ...
            var inter = new SetIntersectionReadOnlyObservableCollection<Person>(list, sList, new PersonEqualityComparer());

            var set = new HashSet<Person>(list, new PersonEqualityComparer());
            set.IntersectWith(sList);
            Assert.IsTrue(set.SetEquals(inter));
        }
        ...
        public void TestAddingItems()
        {
            ...
            var inter = new SetIntersectionReadOnlyObservableCollection<int>(list.ListAsObservable(),
        ...
        public void TestReplacingItems()
        {
            ...
            var inter = new SetIntersectionReadOnlyObservableCollection<int>(list.ListAsObservable(), sList.ListAsObservable());
