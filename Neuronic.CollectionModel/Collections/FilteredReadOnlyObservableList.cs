...
namespace Neuronic.CollectionModel.Collections
{
        ...
        FilteredReadOnlyObservableCollectionBase<T, IndexedFilterItemContainer<T>>, IReadOnlyObservableList<T>, IList<T>
    {
                ...
                filter, itemComparer, triggers)
        {
            ...
            FilteredItems =
                new ObservableCollection<T>(from container in Items where container.Value select container.Item);
        ...
        private void UpdateIndexes(int start, int end)
        {
            ...
            for (var i = start; i < end; i++)
            {
                ...
                nextLocal = Items[i].LocalIndex = Items[i].Value ? nextLocal + 1 : nextLocal;
